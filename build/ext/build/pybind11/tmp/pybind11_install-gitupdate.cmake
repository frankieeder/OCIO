...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v2.6.1"
  WORKING_DIRECTORY "/Users/frankeder/Documents/ocio/build/ext/build/pybind11/src/pybind11_install"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.6.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.6.1")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/frankeder/Documents/ocio/build/ext/build/pybind11/src/pybind11_install'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/frankeder/Documents/ocio/build/ext/build/pybind11/src/pybind11_install'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
