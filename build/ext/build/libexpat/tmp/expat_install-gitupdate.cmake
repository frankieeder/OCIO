...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "R_2_2_8"
  WORKING_DIRECTORY "/Users/frankeder/Documents/ocio/build/ext/build/libexpat/src/expat_install"
...
if("${show_ref_output}" MATCHES "refs/remotes/R_2_2_8")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "R_2_2_8")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/libexpat/libexpat.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/frankeder/Documents/ocio/build/ext/build/libexpat/src/expat_install'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/frankeder/Documents/ocio/build/ext/build/libexpat/src/expat_install'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
