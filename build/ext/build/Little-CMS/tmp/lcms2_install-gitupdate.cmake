...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "lcms2.2"
  WORKING_DIRECTORY "/Users/frankeder/Documents/ocio/build/ext/build/Little-CMS/src/lcms2_install"
...
if("${show_ref_output}" MATCHES "refs/remotes/lcms2.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "lcms2.2")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/mm2/Little-CMS.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/frankeder/Documents/ocio/build/ext/build/Little-CMS/src/lcms2_install'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/frankeder/Documents/ocio/build/ext/build/Little-CMS/src/lcms2_install'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
