...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "yaml-cpp-0.6.3"
  WORKING_DIRECTORY "/Users/frankeder/Documents/ocio/build/ext/build/yaml-cpp/src/yaml-cpp_install"
...
if("${show_ref_output}" MATCHES "refs/remotes/yaml-cpp-0.6.3")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "yaml-cpp-0.6.3")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "yaml-cpp-0.6.3")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/jbeder/yaml-cpp.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/frankeder/Documents/ocio/build/ext/build/yaml-cpp/src/yaml-cpp_install'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/frankeder/Documents/ocio/build/ext/build/yaml-cpp/src/yaml-cpp_install'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
