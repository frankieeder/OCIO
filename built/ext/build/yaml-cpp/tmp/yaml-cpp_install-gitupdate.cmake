    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/frankeder/Documents/ocio/built/ext/build/yaml-cpp/src/yaml-cpp_install'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/frankeder/Documents/ocio/built/ext/build/yaml-cpp/src/yaml-cpp_install'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
